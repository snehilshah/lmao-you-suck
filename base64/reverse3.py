...
query3 = "SELECT MNoFinal, Mper, MPhotoURL from JJCMembers2024_25 where convert(int,MNoFinal)>=4021 and convert(int,MNoFinal)<4101 ORDER BY MNoFinal, Mper;"
...
def base_64_to_image(base64_string, mno, mper):
    try:
        ...
        file_to_save = f"D:/Papa/FinalImg/Iter3/{mno}_{mper}.jpg"
