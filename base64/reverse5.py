...
query5 = "SELECT MNoFinal, Mper, MPhotoURL from JJCMembers2024_25 where convert(int,MNoFinal)>=5046 and MPhotoURL is not null ORDER BY MNoFinal, Mper;"
...
def base_64_to_image(base64_string, mno, mper):
    try:
        ...
        file_to_save = f"D:/Papa/FinalImg/Iter5/{mno}_{mper}.jpg"
